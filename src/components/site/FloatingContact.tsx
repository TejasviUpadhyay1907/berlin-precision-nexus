...
export function FloatingContact() {
  ...
  return (
    ...
    >
      {/* Contact buttons — show on expand or always show on desktop */}
      <div
        className={`flex flex-col items-end gap-2 transition-all duration-300 ${
          expanded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none md:opacity-100 md:translate-y-0 md:pointer-events-auto"
        }`}
      >
