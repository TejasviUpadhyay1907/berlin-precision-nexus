...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Berlin Machineries Private Limited engineers premium CNC Wire Cut EDM, Sinker EDM, milling, grinding and lathe machines. 5000+ installations across India." },
      ...
      { property: "og:description", content: "Premium CNC & EDM machinery for India's most demanding tool rooms." },
